...
if nargin > 2
    ...
    if(t == 0)
        ...
        desired_state.pos = [coefxsegt*t0; coefysegt*t0; coefz(:, index)*t0];
        desired_state.vel = [coefxsegt*velscale'; coefysegt*velscale; coefz(:, index)*velscale];
        desired_state.acc = [coefxsegt*accscale'; coefysegt*accscale; coefz(:, index)*accscale];
...
function [desired_state] = getDesiredState(waypoints, d0, traj_time)
